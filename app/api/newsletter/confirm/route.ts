...
export async function GET(request: Request) {
  ...
  try {
    ...
    if (findError || !subscriber) {
      return new Response('Invalid or expired confirmation token', { status: 400 })
    }
    ...
    if (expiresAt < now) {
      return new Response('Confirmation token has expired. Please subscribe again.', { status: 400 })
    }
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              ...
              <p>
                <a href="https://poriporiluxurylodgeandcamp.com">poriporiluxurylodgeandcamp.com</a>
              </p>
