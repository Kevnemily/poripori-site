      ...
      <section className="relative h-screen min-h-[700px] overflow-hidden bg-[#2C2418]" aria-label="Cuisine hero banner">
        <div className="absolute inset-0 w-full h-full">
          {heroImages.map((img, index) => (
            <div
              key={index}
              className={`absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-[1.2s] ease-in-out z-0 ${
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/45 via-black/15 to-black/50 z-[2]" />
